...
export const ZONES = [
  {
    ...
    tagline: 'Front Row Extraction',
    description: 'Front row counter seating directly facing our custom copper roasters and master baristas.',
    capacity: '1 - 2 Guests',
    icon: Coffee,
    badge: 'High Energy',
  },
  {
    ...
    tagline: 'Intimate & Low Light',
    description: 'Deep velvet plush booths immersed in low ambient lighting, crafted for private conversations.',
    capacity: '2 - 6 Guests',
    icon: Flame,
    badge: 'Intimate Salon',
  },
  {
    id: 'roastery-terrace',
    name: 'The Roastery Terrace',
    tagline: 'Open Air & Atmospheric',
    description: 'Outdoor heated marble tables overlooking our sanctuary gardens and city skyline.',
    capacity: '2 - 8 Guests',
    icon: TreePine,
    badge: 'Open Air',
  },
